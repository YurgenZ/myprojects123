...
// }
//
// let maxNums = maxArrNum([30, 24, 95, 52333, 43, 54, 36, 11, 87, 3])
// console.log(maxNums);
...
//     return min;
// }
// let minArrNums = minArrNum([0, 24, 95, 52333, 43, 54, 36, 11, 87, 3]);
...
// }
//
// let sumElement = sumSomeNums([1, 2, 3, 4])
...
// }
//
// arrFunc(returnKey([{name: 'Dima', age: 13}, {model: 'Camry'},
...
// function arrValue(enter_arr = []) {
//     let arrAll = [];
//     for (const enterArrKey of enter_arr) {
// if (enterArrKey  === enter_arr.value)
//         console.log(enterArrKey);
//     }
//         arrAll.push(Object.values(enter_arr))
//
// return arrAll.flat();
// }

// arrFunc(arrValue([{name: 'Dima', age: 13}, {model: 'Camry'},
//     {name: 'Dima', age: 13}, {model: 'Camry'}]))
